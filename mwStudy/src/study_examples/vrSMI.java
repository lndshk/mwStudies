...
public class vrSMI extends com.motivewave.platform.sdk.study.Study 
{
	...
	enum SMIValmtf {mSMI1, mSMI2, mSMI3, mSMI4};
	enum SMIValDmtf {mD1, mD2, mD3, mD4};
	enum SMIValHLmtf {mHL1, mHL2, mHL3, mHL4};
	enum SMIValD_MAmtf {mD_MA1, mD_MA2, mD_MA3, mD_MA4};
	enum SMIValHL_MAmtf{mHL_MA1, mHL_MA2, mHL_MA3, mHL_MA4};
 ...
 /* final static String HL_PERIOD = "hlPeriod";
  ...
  public void initialize(Defaults defaults)
  {
	  ...
	  /* Stochastic Momentum Index */
		...
		colors3.addRow(new PathDescriptor(SMI_LINE1_MTF, "Line 1", X11Colors.DODGER_BLUE, 1.0f, null, true, true, true));
		colors3.addRow(new PathDescriptor(SMI_LINE2_MTF, "Line 2", X11Colors.BLUE, 1.0f, null, true, true, true));
		colors3.addRow(new PathDescriptor(SMI_LINE3_MTF, "Line 3",  X11Colors.LIME, 1.0f, null, true, true, true));
		colors3.addRow(new PathDescriptor(SMI_LINE4_MTF, "Line 4", X11Colors.DARK_GRAY, 1.0f, null, true, true, true));
  ...
  protected void calculate(int index, DataContext ctx)
  {
	    	...
	    	final String[] SMIenummtf = {"mSMI1", "mSMI2", "mSMI3", "mSMI4"};
	    	final String[] SMIenumDmtf = {"mD1", "mD2", "mD3", "mD4" };
	    	final String[] SMIenumHLmtf = {"mHL1", "mHL2", "mHL3", "mHL4"};
	    	final String[] SMIenumD_MAmtf = {"mD_MA1", "mD_MA2", "mD_MA3", "mD_MA4"};
	        final String[] SMIenumHL_MAmtf = {"mHL_MA1", "mHL_MA2", "mHL_MA3", "mHL_MA4"};
	       
	        for(int i = 0; i <= 3; i++)  // i + 1-> Loop 4 times
	    	{
